class TestPenguScene extends Phaser.Scene {
  constructor() {
    super({ key: 'TestPenguScene' });
    this.fighterName = 'Pengu';
  }
  ...
  preload() {
    ...
    this.load.atlas(
      'pengu_atlas',
      'assets/fighters/sprites/pengu/PENGU.png',
      'assets/fighters/sprites/pengu/PENGU.json'
    );
  ...
  create() {
    ...
    // Create Pengu
    const penguStats = CHARACTERS.find(char => char.name === 'Pengu');
    this.fighter = new Pengu(this, 300, 400, penguStats, true);
